...
namespace Patches::RegularQuicksaves
{
    inline void Install()
    {
        REL::Relocation quickSaveLoadHandlerProcessButtonSaveType{ RELOCATION_ID(0, 52251), 0x68 };
        REL::Relocation quickSaveLoadHandlerProcessButtonLoadType{ RELOCATION_ID(0, 52251), 0x9B };
