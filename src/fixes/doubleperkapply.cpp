...
namespace fixes
{
    ...
    bool PatchDoublePerkApply()
    {
        ...
        Actor_ApplyBasePerks.write_vfunc(0x101, reinterpret_cast<std::uintptr_t>(std::addressof(ApplyBasePerksActor)));
        Character_ApplyBasePerks.write_vfunc(0x101, reinterpret_cast<std::uintptr_t>(std::addressof(ApplyBasePerksActor)));
        PlayerCharacter_ApplyBasePerks.write_vfunc(0x101, reinterpret_cast<std::uintptr_t>(std::addressof(ApplyBasePerksPlayerCharacter)));
